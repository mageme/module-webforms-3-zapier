...
namespace MageMe\WebFormsZapier\Ui\Component\Result\Listing\MassActions\SubActions;
...
class Zapier extends Action
{
    ...
    {
        return [
            'type'    => 'zapier_send_data',
            'label'   => __('Send Data'),
            'url'     => $this->urlBuilder->getUrl(
                'webformszapier/result/ajaxSendSubmission'
            ),
            'isAjax'  => true,
            'confirm' => [
                'title'         => __('Send Data'),
    ...
    protected function isDisabled(): bool
    {
        ...
        try {
            /** @var \MageMe\WebFormsZapier\Api\Data\FormInterface $form */
            $form = $this->formRepository->getById($formId);
            if (!$form->getIsZapierWebhookEnabled() || !$form->getZapierWebhookUrl()) {
                return true;
            }
